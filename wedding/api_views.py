        ...
        'photos': [
            {
                ...
                'image_url': photo.get_optimized_url() or photo.image.url if photo.image else None,
                'full_image_url': photo.get_full_size_url() or photo.get_optimized_url() or photo.image.url if photo.image else None,
